  ...
  return (
    <footer id="faq" className="bg-current/5 border-t border-current/15 pt-16 pb-12 px-4 sm:px-8">
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        {/* With Regards — only shown when content is provided */}
        {hasWithRegards && (
          <div className="text-center space-y-4 max-w-2xl mx-auto py-10 border-y border-current/15">
            <Heart className={`w-5 h-5 mx-auto fill-current ${accentClass}`} />
            <p className="text-[10px] uppercase tracking-[0.3em] opacity-60 font-semibold">With Regards</p>
            <p className="font-serif text-base sm:text-lg leading-relaxed opacity-90 whitespace-pre-line">
              {withRegards}
            </p>
          </div>
        )}
